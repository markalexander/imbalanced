...
class SKLearnSyntheticClassification(torch.utils.data.TensorDataset):
    ...
    def __init__(
        ...
        super().__init__(torch.from_numpy(inputs), torch.from_numpy(targets))
...
class SKLearnSyntheticRegression(torch.utils.data.TensorDataset):
